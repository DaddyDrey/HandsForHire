...
namespace HandsForHire.DataAccesLayer.Migrations
{
    ...
    [Migration("20260604170000_AddUserProfileFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HandsForHire.Domain.Entities.Conversation", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<DateTime>("CreatedAt").HasColumnType("TEXT");
                    b.Property<DateTime>("LastMessageAt").HasColumnType("TEXT");
                    b.Property<int>("ProId").HasColumnType("INTEGER");
                    b.Property<int>("UserId").HasColumnType("INTEGER");
                    b.HasKey("Id");
                    b.HasIndex("UserId", "ProId").IsUnique();
            ...
            modelBuilder.Entity("HandsForHire.Domain.Entities.Pro", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int>("BirthYear").HasColumnType("INTEGER");
                    b.Property<string>("City").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("Description").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("Email").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("FullName").IsRequired().HasColumnType("TEXT");
                    b.Property<decimal>("HourlyRate").HasColumnType("TEXT");
                    b.Property<int>("Status").HasColumnType("INTEGER");
                    b.Property<string>("Trade").IsRequired().HasColumnType("TEXT");
                    b.HasKey("Id");
                    b.ToTable("Pros");
                });
            ...
            modelBuilder.Entity("HandsForHire.Domain.Entities.Profession", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Name = "Electrician" },
                        new { Id = 2, Name = "Plumber" },
                        new { Id = 3, Name = "Carpenter" },
                        new { Id = 4, Name = "Painter" },
                        new { Id = 5, Name = "HVAC" },
                        new { Id = 6, Name = "Handyman" });
                });

            modelBuilder.Entity("HandsForHire.Domain.Entities.Report", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int>("ActionTaken").HasColumnType("INTEGER");
                    b.Property<int>("Category").HasColumnType("INTEGER");
                    b.Property<DateTime>("CreatedAt").HasColumnType("TEXT");
                    b.Property<string>("Description").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("ReporterEmail").IsRequired().HasColumnType("TEXT");
            ...
            modelBuilder.Entity("HandsForHire.Domain.Entities.Review", b =>
                {
                    ...
                    b.Property<string>("ReviewerEmail").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("ReviewerName").IsRequired().HasColumnType("TEXT");
                    b.HasKey("Id");
                    b.ToTable("Reviews");
                });
